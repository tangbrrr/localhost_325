...
func (p *MondPlugin) genServer(gf *protogen.GeneratedFile, svc *protogen.Service) {
	...
	gf.P(fmt.Sprintf(`Unimplemented%sServiceServer`, serviceName))
...
func (p *MondPlugin) genImport(gf *protogen.GeneratedFile, f *protogen.File) {
	...
	gf.P(`"fmt"`)
	gf.P()
	gf.P(`merr "github.com/tangbo/twatt/mond/wind/err"`)
	gf.P(`mgrpc "github.com/tangbo/twatt/mond/wind/grpc"`)
	gf.P(`"github.com/tangbo/twatt/mond/wind/config"`)
	gf.P(`"github.com/tangbo/twatt/mond/wind/env"`)
	gf.P()
